                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <h3 class="card-title col-md-4 my-auto">Listado de Inspectores</h3>
                                <div class="col-md-5">
                                    <div>
                                        <div class="form-inline col-md-12 justify-content-center mt-sm-3  mt-md-0">
                                            <input id="search" name="search" class="form-control col-6 mr-1" type="search"
                                                placeholder="Número de empleado" value="@php echo $search ?? '' @endphp">
                                            <button class="btn btn-outline-success mr-2" onclick="search()" >
                                                <i class="fas fa-search"></i>
                                            </button>
                                            <a id="btn-clean" href="{{ route('inspectores.index') }}"
                                                type="button" class="btn btn-light rounded-pill"
