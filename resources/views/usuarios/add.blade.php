                            ...
                            <form role="form" id="form1" name="form1">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                <label>Nombre</label><input type="text" class="form-control" id="nombre"
                                                    ...
                                                    aria-invalid="true" placeholder="Nombre">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                <label>Apellidos</label><input class="form-control" type="text"
                                                    id="apellidos" name="apellidos" value="" placeholder="Apellidos">
                                                <span class="glyphicon glyphicon-info-sign  form-control-feedback"></span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;"
                                                    ...
                                                    @foreach ($dependencia_items as $item)
                                                        <option value="{{ $item->id }}">{{ $item->dependencia }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-3">
                                            <div class="form-group has-feedback">
                                                <label>Numero de extension(es)</label><input class="form-control"
                                                    type="text" id="extension" name="extension" value=""
                                                    placeholder="Extension(es)">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group has-feedback">
                                                <label>Celular</label><input class="form-control" type="text"
                                                    name="celular" value="" placeholder="Celular">
