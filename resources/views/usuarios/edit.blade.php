                            ...
                            <div class="card-body">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                <label>Usuario (Correo)</label><input type="text" class="form-control"
                                                    id="username" name="username" aria-required="true"
                                                    aria-describedby="url-error" aria-invalid="true"
                                                    placeholder="usuario@mail.com" value="@php echo $info->username @endphp"><span
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                <label>Contraseña</label><input type="password" class="form-control"
                                                    id="password" name="password" aria-required="true"
                                                    aria-describedby="url-error" aria-invalid="true">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                <label>Nombre</label><input type="text" class="form-control" id="nombre"
                                                    name="nombre" aria-required="true" aria-describedby="url-error"
                                                    aria-invalid="true" placeholder="Nombre" value="@php echo $info->nombres @endphp">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                <label>Apellidos</label><input class="form-control" type="text"
                                                    id="apellidos" name="apellidos" value="@php echo $info->apellidos @endphp"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;"
                                                    id="dependencia_id" name="dependencia_id" onchange="selectDependencia()">
                                                    <option value="" selected>Seleccione Dependencia</option>
                                                    @foreach ($dependencia_items as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == $info->dependencia_id ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group has-feedback">
                                                <label>Area que labora</label>
                                                <select class="form-control select2" style="width: 100%;"
                                                    id="subdependencia_id" name="subdependencia_id">
                                                    <option value="" selected>
                                                        Area laboral
                                                    </option>
                                                    @foreach ($subdependencia_items as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == $info->area_laboral ? 'selected' : '' }}>
                                                            {{ $item->dependencia }}</option>
                                                    @endforeach
                                                </select>
                                                <span class="glyphicon glyphicon-info-sign  form-control-feedback"></span>
