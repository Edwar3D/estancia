...
<body>
    ...
    <div class="container-fluid p-4">
        @section('options')
        <form id="form_inspectores" action="{{route('ciudadano2')}}" class="my-3">
        ...
        <div class="row">
            <div class="col-6 px-3">
                @include('components.tabla_inspectores')
            </div>
    ...
    <script>
        ...
        function selectDependencia(){
            ...
            location.href="/ciudadano2?select_dependencia="+event.target.value+"&search="+document.getElementById('search').value;
        }
    </script>
